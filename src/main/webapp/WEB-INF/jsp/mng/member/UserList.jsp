...
<script type="text/javascript">
    $(document).ready(function () {
    	$("#pageUnit").on("change", function(){
    		$('#listForm').attr('action', '/mng/member/User/UserList');
    	    $("#pageIndex").val(1);
    	    $("#listForm").submit();
    	});
    });
    ...
    function fnRegistForm(){
		location.href='/mng/member/User/UserRegistForm';
    }
 ...
 <input type="hidden" name="seq" id="seq" />
	<div class="search-box-wrap">
	    <div class="inner">
			...
			<div class="table-col">
				<div class="th">회원구분</div>
				<div class="td">
					<div class="select-wrap w486">
						<select class="select" name="type">
							<option value="">전체</option>
							<option value="d" ${searchVO.type eq "d" ? "selected" : "" }>직조직</option>
							<option value="p" ${searchVO.type eq "p" ? "selected" : "" }>파트너</option>
						</select>
					</div>
				</div>
			</div>

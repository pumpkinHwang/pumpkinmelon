<%
  ...
  * @ 수정일                수정자           수정내용
  * @ ----------   --------   ---------------------------
  * @ 2009.03.09   황장운            최초 생성
  *   2016.08.05   황장운            표준프레임워크 v3.6 개선
	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
			   ...
			   <a href="javascript:" onClick="fn_egov_Schdule_DiaryManage()"><img src="<c:url value='/images/egovframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt=<spring:message code="comCopSmtDsm.registBtn.schdulCn"/> title="<spring:message code="comCopSmtDsm.registBtn.schdulCn"/>"></a>

...
public class SessionCookieUtil {
	 ...
	 * @throws Exception
	 */
	public static Object getSessionAttribute(HttpServletRequest request, String keyStr) throws IOException {
	 ...
	 * @param value
	 */
	public static void setAttribute(String key, Object value) throws Exception {
	    HttpServletRequest request =((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest();
	...
	public static String getId() throws Exception {
		...
		if(request.getRequestURI().indexOf("/ncp/") > -1) {
			obj = request.getSession().getAttribute("loginVO_NCP");
		}else if(request.getRequestURI().indexOf("/mcp/") > -1) {
			obj = request.getSession().getAttribute("loginVO_MCP");
		}

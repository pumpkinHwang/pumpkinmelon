...
public class EgovCnsltManageController {
    ...
    public String updateCnsltDtlsView(
        ...
        model.addAttribute("data",selectCnsltListDetail("Y", cnsltManageVO, searchVO, model));
    ...
    public String updateCnsltDtlsAnswerView(
        ...
        // 변수명은 CoC 에 따라
        model.addAttribute("data",selectCnsltAnswerListDetail(cnsltManageVO, searchVO, model));

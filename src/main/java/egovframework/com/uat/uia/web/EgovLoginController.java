 ...
 *  2011.09.07   황장운           스프링 시큐리티 로그인 및 SSO 인증 로직을 필터로 분리
 *  2011.09.25   황장운           사용자 관리 컴포넌트 미포함에 대한 점검 로직 추가
 *  2011.09.27   황장운           인증서 로그인시 스프링 시큐리티 사용에 대한 체크 로직 추가
 *  2011.10.27   황장운           아이디 찾기 기능에서 사용자 리름 공백 제거 기능 추가
 *  2017.07.21   황장운           로그인인증제한 작업
 *  2018.10.26   황장운           로그인 화면에 message 파라미터 전달 수정
 *  2019.10.01   황장운           로그인 인증세션 추가
 *  2020.06.25   황장운           로그인 메시지 처리 수정
 *  2021.01.15   황장운           로그아웃시 권한 초기화 추가 : session 모드 actionLogout()
 *  2021.05.30   황장운           디지털원패스 처리하기 위해 로그인 화면에 인증방식 전달
 *  
 *  </pre>
 */
@Controller

 ...
 *  2011.09.16   황장운            컨텐츠 페이지 생성
 *  2011.09.26     황장운		header, footer 페이지 생성
 *  2019.12.04   황장운            KISA 보안코드 점검 : Map<Integer, IncludedCompInfoVO> map를 지역변수로 수정
 *  2020.07.08   황장운           비밀번호를 수정한후 경과한 날짜 조회
 *  2020.08.28   황장운            표준프레임워크 v3.10 개선
 * </pre>
 */
